  ...
  return (
    ...
    <div className={blogStyles.blogMain}>
      <section className={blogStyles.sectionTitle}>
        ...
        <span className={blogStyles.published}>
          Published on Apr. 11, 2021 by Alberto Vargas
        </span>
        <br />
      </section>
      <p className={blogStyles.p}>
        As a Dominican, I have a fond love for beans. In fact, the dish we refer
        to as our national “bandera”, or flag, consists of rice, beans (usually
        the kidney kind), and meat. The colors of these foods don’t actually
        match our national flag’s, but if you ask a Dominican for a bandera,
        they may first imply you’re hungry. As I’ve grown in my love for
        comforting food, I’ve acquired knowledge on how to tweak my beans in a
        tasteful direction. Today, I’m happy to share some of my insights.
      </p>
      {/* <p className={blogStyles.p}>
        These 3 items help me achieve all of these:
      </p> */}
      <div>
        <section>
          ...
          <p className={blogStyles.p}>
            This might seem redundant to those with the habit of sautéing onions
            and garlic as they start making any dish. However, living on the
            East Coast in the US has made me hyper aware of how the flavor of my
            beans differ from those made in a more “Westernized” manner. I’ve
            noticed that when eating baked, pinto, or black beans in American
            restaurants or people’s homes, these had good mouthfeel, but only
            tasted of salt and pepper. I love adding cooked yellow onions,
            garlic, and cubanelle peppers when making red kidney, pinto, black,
            or garbanzo beans. Every now and then, I also add tomato paste to
            the vegetable mix, before adding all to the beans for some extra
            color and thickening of the bean broth. You should definitely feel
            free to add other kinds of peppers to your aromatics, and even a
            touch of celery to vary the flavor of your beans.
          </p>
        </section>

        <section>
          <h3>Using fresh herbs</h3>
          <p className={blogStyles.p}>
            I’m sure the following is practiced in different cuisines. However,
            in my experience, one of the classic default flavors within beans
            made by Dominican moms comes from cilantro. When I was a younger and
            much pickier eater, I would get grossed out by the green stems my
            mom would tell me to pick out when she served me kidney beans from
            their pot. “Wacala, mami!” I would say, but as soon as I started
            eating the damn beans I’d be enveloped by comfort and ask for
            seconds. This might sound weird to some, but when I make beans, I
            usually throw a half-bunch to a bunch (depending on the water:bean
            ratio) of washed cilantro in the pot before slow or pressure-cooking
            them. I don’t cut the cilantro at all (unless there are sad, ugly
            parts), since their only purpose is to give flavor. When the beans
            are cooked, I simply take them out for compost and proceed to have
            delicious rice and beans. If you’re unlucky and have the gene that
            makes cilantro taste like soap, I’m deeply sorry for you. But! I
            think you can achieve parallel complexity if you use culantro, which
            is a different plant with a similar, but stronger taste than
            cilantro. I would therefore use it more sparingly. If you just don’t
            like the flavor of cilantro/culantro at all, I would challenge you
            to sauté some bay leaves along with your onions, garlic, and other
            aromatics, then adding them to your beans before slow or pressure
            cooking them.
          </p>
        </section>
        <section>
          <p className={blogStyles.p}>
            I hope you try these at home, or experiment with your own ways of
            adding flavor to beans. Until next time!
          </p>
        </section>
      </div>
    </div>
